...
public class StreamReader {
	 ...
	 */
	public StreamReader(JSON_Reader reader) {
		super();
		this.reader = reader;
	 ...
	 * @throws Exception
	 */
	public void check(char c) throws JSON_ParsingException {
		if(this.c != c){
			throw new JSON_ParsingException((char) this.c, line, column,
					"Expected char was: "+c);
		}
	}
	 ...
	 * @throws Exception
	 */
	public void check(char... expectedChars) throws JSON_ParsingException {
		if(!isOneOf(expectedChars)){
			throw new JSON_ParsingException(line, column, "Unexpected sequence encountered while deserializing");
		}
	}
	 ...
	 * @throws IOException
	 */
	public void checkSequence(String sequence) throws JSON_ParsingException, IOException {
		if(isRunning){
			int n = sequence.length();
			for(int i = 0; i < n; i++) {
				char expectedChar = sequence.charAt(i);
				if(c != expectedChar) {
					throw new JSON_ParsingException(line, column, "Sequence not matching");
				}
				moveNext();
			}
		}
		else{
			throw new JSON_ParsingException(line, column, "Attempting to read closed stream");
		}
	}


	public void moveNext() throws IOException, JSON_ParsingException {
		if(isRunning){
	 ...
	 */
	public void skip(char... skipped) throws IOException, JSON_ParsingException {
	...
	public void moveToNextSymbol() throws JSON_ParsingException, IOException {
		moveNext();
		skip('\n', '\t', ' ');
	}
	 ...
	 * @throws IOException
	 */
	public String readAlphanumericChain() throws JSON_ParsingException, IOException {
	 ...
	 * @throws IOException
	 */
	public String readQuotedChain() throws JSON_ParsingException, IOException {
